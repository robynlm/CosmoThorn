...
extern "C" void CosmoLapse_dtLapsePostStepBoundary_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CosmoLapse_dtLapsePostStepBoundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(CosmoLapse_dtLapsePostStepBoundary_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CosmoLapse_dtLapsePostStepBoundary_calc_every != CosmoLapse_dtLapsePostStepBoundary_calc_offset)
    return;
...
static void CosmoLapse_dtLapsePostStepBoundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(CosmoLapse_dtLapsePostStepBoundary,
  ...
  CCTK_ENDLOOP3(CosmoLapse_dtLapsePostStepBoundary);
}
extern "C" void CosmoLapse_dtLapsePostStepBoundary(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CosmoLapse_dtLapsePostStepBoundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(CosmoLapse_dtLapsePostStepBoundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CosmoLapse_dtLapsePostStepBoundary_Body");
  }
  if (cctk_iteration % CosmoLapse_dtLapsePostStepBoundary_calc_every != CosmoLapse_dtLapsePostStepBoundary_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN::ML_lapserhs"};
  AssertGroupStorage(cctkGH, "CosmoLapse_dtLapsePostStepBoundary", 3, groups);
  ...
  LoopOverBoundary(cctkGH, CosmoLapse_dtLapsePostStepBoundary_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CosmoLapse_dtLapsePostStepBoundary_Body");
  }
}
