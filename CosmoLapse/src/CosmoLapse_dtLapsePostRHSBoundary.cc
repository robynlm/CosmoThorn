...
extern "C" void CosmoLapse_dtLapsePostRHSBoundary_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CosmoLapse_dtLapsePostRHSBoundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(CosmoLapse_dtLapsePostRHSBoundary_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CosmoLapse_dtLapsePostRHSBoundary_calc_every != CosmoLapse_dtLapsePostRHSBoundary_calc_offset)
    return;
...
static void CosmoLapse_dtLapsePostRHSBoundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(CosmoLapse_dtLapsePostRHSBoundary,
  ...
  CCTK_ENDLOOP3(CosmoLapse_dtLapsePostRHSBoundary);
}
extern "C" void CosmoLapse_dtLapsePostRHSBoundary(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CosmoLapse_dtLapsePostRHSBoundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(CosmoLapse_dtLapsePostRHSBoundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CosmoLapse_dtLapsePostRHSBoundary_Body");
  }
  if (cctk_iteration % CosmoLapse_dtLapsePostRHSBoundary_calc_every != CosmoLapse_dtLapsePostRHSBoundary_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN::ML_lapserhs"};
  AssertGroupStorage(cctkGH, "CosmoLapse_dtLapsePostRHSBoundary", 3, groups);
  ...
  LoopOverBoundary(cctkGH, CosmoLapse_dtLapsePostRHSBoundary_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CosmoLapse_dtLapsePostRHSBoundary_Body");
  }
}
